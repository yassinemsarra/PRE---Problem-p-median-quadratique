...
function main()
    ...
    for (n_clients, n_sites, p) in instances
        ...
        # Résolution
        relax, obj, bnd, gp, nds, t = solve_p_median_quadratic_convex(n_clients, n_sites, p, d, f, Q)

        # Enregistrement
        push!(results, ("convexification", n_clients, n_sites, p, relax, obj, bnd, gp, nds, t))
    end
